...
const LEGAL_CONTENT = {
  terms: {
    ...
    sections: [
      ...
      {
        heading: "Contact",
        body: "For questions about these Terms, contact CiP at contact@christiansinpolitics.com or write to: Christians in Politics Australia Ltd, PO Box South Hurstville, NSW 2221, Australia.",
      },
    ],
  },
  privacy: {
    ...
    sections: [
      {
        heading: "Who we are",
        body: "Christians in Politics Australia Ltd (ABN 93 697 747 630) is an Australian registered charity operating the Christians in Politics member network, including the CiP Network app and network.christiansinpolitics.com. We are privacy-first: no advertising, no third-party analytics or tracking, and we never sell or rent your personal information. We handle personal information under the Privacy Act 1988 (Cth) and the Australian Privacy Principles.",
      },
      {
        heading: "What we collect",
        body: "Account and profile information you provide: name, email, password (stored only as a secure hash), and optionally mobile number, job title, employer, bio, suburb or postcode (used to derive your state and electorates), profile photo, and a church you attend. Content you create: posts, comments, reactions, polls, images and documents, messages, event registrations, group memberships, connection requests, and support requests. Technical information: your account identifier, sign-in timestamps, and a device push token if you enable push notifications. We do not collect GPS location, contacts, advertising identifiers, or browsing history.",
      },
      {
        heading: "Sensitive information",
        body: "Because CiP is a faith-based network, we ask for information the Privacy Act classifies as sensitive: your Christian tradition, your affirmation of the Nicene Creed, and optionally your political party affiliation. We collect this only with your consent, given when you provide it. Tradition and church are never shown in the member directory, and party affiliation is shown to other members only if you switch on the option in your profile.",
      },
      {
        heading: "Why we collect it",
        body: "To operate your membership (account, profile, feed, groups, events, messaging); to connect you with other members; to provide personal support (support requests are visible only to the CiP team); to send the notifications you have chosen; to keep the community safe (reported or flagged content is reviewed by CiP moderators, assisted by automated AI monitoring for conduct that may breach the Member Conduct Agreement); and to meet our legal obligations as an Australian charity. We do not use your information for advertising or profiling, and we do not use it to train AI models.",
      },
      {
        heading: "Who can see what",
        body: "Other members see only the profile fields you choose to share. In your Privacy settings you can hide individual fields or opt out of the member directory entirely. Members you block cannot message you or send connection requests, and you will not see their content. The CiP team can access member records and support requests to run the platform and moderate reported content. The public sees nothing: the member area is closed.",
      },
      {
        heading: "Disclosure to service providers",
        body: "We disclose personal information only to providers who process it on our instructions: Supabase (secure database, authentication and storage, hosted in Australia in the AWS Sydney region), Resend (sends our emails), Apple and Google (deliver push notifications if you enable them), and Vercel (hosts the web platform). Some providers are located overseas, principally the United States; where information is processed overseas we take reasonable steps consistent with APP 8 to ensure comparable protection. We may also disclose information where required by law or with your express consent. We never sell, rent, or trade personal information.",
      },
      {
        heading: "Security",
        body: "All data is encrypted in transit and at rest. Access is restricted by row-level security controls, sensitive fields are stored in a separately protected table, passwords are hashed, and you can add two-factor authentication in Settings. If a data breach occurs that is likely to result in serious harm, we will notify affected members and the OAIC as required by the Notifiable Data Breaches scheme.",
      },
      {
        heading: "Retention and deletion",
        body: "We keep personal information while your membership is active. You can delete your account at any time in Settings, which permanently removes your account and associated data. Support-request and moderation records may be retained where legally required or needed to resolve a dispute. Backups are purged on a rolling basis.",
      },
      {
        heading: "Your choices and rights",
        body: "At any time in the app you can edit or remove profile fields, control field-level visibility and discoverability, block or unblock members, manage notifications per type, and delete your account. You may also request access to, or correction of, the personal information we hold by contacting us. If you are dissatisfied with our response you may complain to the Office of the Australian Information Commissioner (oaic.gov.au).",
      },
      {
        heading: "Age",
        body: "Membership requires you to confirm you are 16 or older; we record that confirmation. The platform is not directed at children under 16.",
      },
      {
        heading: "Contacting CiP about privacy",
        body: "Privacy Officer, Christians in Politics Australia Ltd, contact@christiansinpolitics.com, PO Box South Hurstville, NSW 2221, Australia. The current version of this policy is always available at christiansinpolitics.com/privacy.",
      },
    ],
  },
  conduct: {
